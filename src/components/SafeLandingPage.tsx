...
const SafeLandingPage = () => {
  ...
  // Static portfolio data (no API calls)
  ...
  const totalSlides = Math.ceil(staticPortfolio.length / itemsPerSlide);
  ...
  const handleEnquirySubmit = async (e: React.FormEvent) => {
    ...
    // Simulate form submission (no API call to avoid auth issues)
    setTimeout(() => {
                ...
                {Array.from({ length: totalSlides }).map((_, slideIdx) => (
                  <div key={slideIdx} className="w-full flex-shrink-0 px-4 sm:px-0">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                      {staticPortfolio.slice(slideIdx * itemsPerSlide, (slideIdx + 1) * itemsPerSlide).map((item) => (
                        <div key={item.id} className="group relative overflow-hidden rounded-xl aspect-square border border-gray-200 shadow-md">
          ...
          <div className="grid md:grid-cols-3 gap-8 pt-8 border-t border-gray-200">
            <div>
              ...
              <ul className={`space-y-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Banner Printing')}
                ...
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Brand Design')}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Brand Design
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Installation Services')}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
            ...
            <div>
              ...
              <ul className={`space-y-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Commercial Markets')}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Commercial Markets
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Shopping Malls')}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Shopping Malls
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Roadside Stalls')}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Roadside Stalls
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => console.log('Navigate to Business Districts')}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Business Districts
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => {
                      ...
                      console.log('Navigate to Our Services');
                    }}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Our Services
                ...
                <li>
                  <button 
                    onClick={() => {
                      ...
                      console.log('Navigate to Our Process');
                    }}
                    className="hover:text-yellow-500 transition-colors cursor-pointer text-left"
                  >
                    Our Process
