...
export default function StoresPage() {
  ...
  const downloadExcel = async (
    ...
    try {
      ...
      const response = await api.get(`/stores/${storeId}/excel/${type}`, {
        responseType: "blob",
      });
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement("a");
  ...
  const toggleDownloadMenu = (storeId: string, type: string) => {
    if (
      downloadMenuOpen?.storeId === storeId &&
      downloadMenuOpen?.type === type
    ) {
          ...
          >
            ...
            >
              <p
                className={`font-bold text-base ${darkMode ? "text-white" : "text-gray-900"}`}
              >
                Delete {selectedStoreIds.size} store(s)?
              </p>
            </div>
            <div className="px-6 py-4">
              <p
                className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}
              >
                This action cannot be undone. All selected stores will be
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.errorCount > 0) {
        toast.error(
          `Upload rejected: ${data.errorCount} errors found. Fix and re-upload.`,
        );
      } else {
  ...
  const handleExportUploadResults = (type: "valid" | "invalid" | "all") => {
    ...
    toast.success(
      `${type.charAt(0).toUpperCase() + type.slice(1)} rows exported!`,
    );
  };
  ...
  const getStatusColor = (status: StoreStatus) => {
    switch (status) {
      ...
      case StoreStatus.INSTALLATION_ASSIGNED:
        return "bg-indigo-100 text-indigo-800";
      case StoreStatus.INSTALLATION_SUBMITTED:
    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          >
            Manage and track all store activities
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <button
            onClick={handleExportStores}
            className="inline-flex items-center px-3 sm:px-4 py-2 rounded-lg font-medium text-sm bg-green-600 hover:bg-green-700 text-white"
          >
      ...
      <div
        className={`p-4 rounded-xl border ${darkMode ? "bg-purple-900/30 border-purple-700/50" : "bg-white border-gray-200"}`}
      >
      ...
      {/* Table */}
      <div
        className={`rounded-xl border overflow-hidden shadow-sm ${darkMode ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"}`}
      >
        {isLoading ? (
          <div className="p-6">
                  ...
                  {[...Array(limit)].map((_, i) => (
                    <tr key={i}>
                      <td className="px-4 py-4">
                        <div
                          className={`h-5 w-5 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                        <div
                          className={`h-4 w-24 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                        <div
                          className={`h-4 w-20 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                        <div
                      ...
                      <td className="px-4 py-4">
                        <div
                          className={`h-4 w-32 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                        <div
                      ...
                      <td className="px-4 py-4">
                        <div
                          className={`h-4 w-16 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                        <div
                      ...
                      <td className="px-4 py-4">
                        <div
                          className={`h-4 w-12 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                        <div
                      ...
                      <td className="px-4 py-4">
                        <div
                          className={`h-6 w-20 rounded-full animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-4 py-4">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex justify-end gap-1.5">
                          {[...Array(3)].map((_, j) => (
                            <div
                              key={j}
                              className={`h-8 w-8 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                            />
                          ))}
                        </div>
                      </td>
            ...
            <div
              className={`px-4 py-3 flex items-center justify-between border-t ${darkMode ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-gray-50"}`}
            >
              <div
                className={`h-4 w-48 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
              />
              <div className="flex items-center gap-2">
                <div
                  className={`h-8 w-24 rounded animate-pulse ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}
                />
          ...
          <>
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className={darkMode ? "bg-gray-800/50" : "bg-gray-50"}>
                  <tr>
                    ...
                    <th
                      className={`px-4 py-4 text-right text-sm font-medium ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                    >
                      Action
                    </th>
                  </tr>
                ...
                >
                  {stores.map((store, index) => {
                    ...
                    return (
                      <tr
                        key={store._id}
                        className={`transition-colors ${isSelected ? (darkMode ? "bg-blue-900/30" : "bg-blue-50") : darkMode ? "hover:bg-gray-800" : "hover:bg-gray-50"}`}
                      >
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          <div
                            className={`text-sm font-mono font-semibold ${darkMode ? "text-yellow-400" : "text-yellow-600"}`}
                          >
                            {store.storeId || "-"}
                          </div>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap">
                          <div
                            className={`text-sm font-mono ${darkMode ? "text-blue-400" : "text-blue-600"}`}
                          >
                            {store.clientCode || "-"}
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          <div
                            className={`text-sm font-mono font-semibold ${darkMode ? "text-gray-100" : "text-gray-900"}`}
                          >
                            {store.dealerCode}
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-4">
                          <div
                            className={`text-sm max-w-[200px] truncate ${darkMode ? "text-gray-200" : "text-gray-900"}`}
                        ...
                        {!isRecceOrInstallUser && (
                          <>
                            ...
                            <td className="px-4 py-4">
                              <div
                                className={`text-xs max-w-[150px] truncate ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                                title={store.remark}
                              >
                                {store.remark || "-"}
                              </div>
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          <span
                            className={`px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide rounded-full ${getStatusColor(store.currentStatus)}`}
                          >
                          ...
                          <div className="space-y-1.5">
                            {store.workflow.recceAssignedTo ? (
                              ...
                              >
                                ...
                                <span
                                  className={`truncate max-w-[100px] ${darkMode ? "text-gray-200" : "text-gray-900"}`}
                                >
                              ...
                              <div
                                className={`text-xs italic ${darkMode ? "text-gray-500" : "text-gray-400"}`}
                              >
                                Unassigned
                              </div>
                            )}
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-right">
                          <div className="flex justify-end items-center gap-1.5">
                            <button
                              ...
                              className="p-1.5 rounded hover:bg-gray-100/50 dark:hover:bg-gray-700/50 text-blue-600"
                              title="View Details"
                            >
                            ...
                            {store.currentStatus ===
                              ...
                              <>
                                <button
                                  ...
                                  className="p-1.5 rounded hover:bg-green-50/50 dark:hover:bg-green-900/20 text-green-600"
                                  title="Approve Recce"
                                >
                                  <Check className="w-4 h-4" />
                                </button>
                                <button
                                  onClick={() => handleRejectRecce(store._id)}
                                  className="p-1.5 rounded hover:bg-red-50/50 dark:hover:bg-red-900/20 text-red-600"
                                  title="Reject Recce"
                                >
                                ...
                                <div className="relative">
                                  <button
                                    onClick={() =>
                                      toggleDownloadMenu(store._id, "recce")
                                    }
                                    className="p-1.5 rounded hover:bg-orange-50/50 dark:hover:bg-orange-900/20 text-orange-600"
                                    title="Download Recce"
                                  >
                                    <Download className="w-4 h-4" />
                                  </button>
                                  {downloadMenuOpen?.storeId === store._id &&
                                    downloadMenuOpen?.type === "recce" && (
                                      <div
                                        className={`absolute right-0 mt-1 w-32 rounded-lg shadow-lg z-50 ${darkMode ? "bg-gray-800 border border-gray-700" : "bg-white border border-gray-200"}`}
                                      >
                                        <button
                                          onClick={() =>
                                            handleDownload(
                                          ...
                                          className={`w-full px-3 py-2 text-left text-sm flex items-center gap-2 ${darkMode ? "hover:bg-gray-700 text-gray-200" : "hover:bg-gray-50 text-gray-700"}`}
                                        >
                              ...
                              <>
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    className="p-1.5 rounded hover:bg-purple-50/50 dark:hover:bg-purple-900/20 text-purple-600"
                                    title="Download Installation"
                                  >
                                    <Download className="w-4 h-4" />
                                  </button>
                                  {downloadMenuOpen?.storeId === store._id &&
                                    downloadMenuOpen?.type ===
                                      "installation" && (
                                      <div
                                        className={`absolute right-0 mt-1 w-32 rounded-lg shadow-lg z-50 ${darkMode ? "bg-gray-800 border border-gray-700" : "bg-white border border-gray-200"}`}
                                      >
            ...
            <div className="lg:hidden space-y-3 p-4">
              {stores.map((store) => {
                ...
                return (
                  <div
                    key={store._id}
                    className={`p-4 rounded-lg border ${isSelected ? (darkMode ? "bg-blue-900/30 border-blue-500" : "bg-blue-50 border-blue-300") : darkMode ? "bg-gray-800/30 border-gray-700" : "bg-white border-gray-200"}`}
                  >
                    {/* Header Row */}
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <div
                            className={`text-sm font-bold ${darkMode ? "text-yellow-400" : "text-yellow-600"} mb-1`}
                          >
                            {store.storeId || store.dealerCode}
                          </div>
                          <div
                            className={`text-base font-semibold ${darkMode ? "text-white" : "text-gray-900"} truncate`}
                          >
                            {store.storeName}
                          </div>
                          <div
                      ...
                      <span
                        className={`px-2 py-1 text-[10px] font-bold uppercase rounded-full whitespace-nowrap ${getStatusColor(store.currentStatus)}`}
                      >
                        {store.currentStatus.replace(/_/g, " ")}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-mono font-semibold ${darkMode ? "text-gray-100" : "text-gray-900"}`}
                        >
                          {store.dealerCode}
                        </span>
                      </div>
                      {store.specs && (
                        <div className="flex justify-between">
                          ...
                          >
                            {store.specs.width}x{store.specs.height} ft (Qty:{" "}
                            {store.specs.qty})
                          </span>
                        </div>
                      )}
                      ...
                      {store.workflow.recceAssignedTo && (
                        <div className="flex justify-between items-center">
                          ...
                          <span
                            className={`text-xs ${darkMode ? "text-gray-200" : "text-gray-900"}`}
                          >
                            {(store.workflow.recceAssignedTo as any).name}
                          </span>
                        </div>
                      ...
                      {store.workflow.installationAssignedTo && (
                        <div className="flex justify-between items-center">
                          ...
                          >
                            {
                              (store.workflow.installationAssignedTo as any)
                                .name
                            }
                          </span>
                        </div>
                    ...
                    {/* Actions */}
                    <div
                      className={`flex flex-wrap gap-2 mt-3 pt-3 border-t ${darkMode ? "border-gray-700" : "border-gray-200"}`}
                    >
                      <button
                        onClick={() => router.push(`/store/${store._id}`)}
                      ...
                      {store.currentStatus === StoreStatus.RECCE_SUBMITTED && (
                        <>
                          <button
                            onClick={() => handleApproveRecce(store._id)}
                            className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-green-50 text-green-600 text-xs font-medium"
                          >
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-orange-50 text-orange-600 text-xs font-medium"
                            >
                      ...
                      {store.currentStatus === StoreStatus.COMPLETED && (
                        <>
                          ...
                          <div className="relative">
                            <button
                              onClick={() =>
                                toggleDownloadMenu(store._id, "installation")
                              }
                              className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-purple-50 text-purple-600 text-xs font-medium"
                            >
                              <Download className="w-3.5 h-3.5" /> Install
                            </button>
                            {downloadMenuOpen?.storeId === store._id &&
                              downloadMenuOpen?.type === "installation" && (
                                <div
                                  className={`absolute right-0 mt-1 w-32 rounded-lg shadow-lg z-50 ${darkMode ? "bg-gray-800 border border-gray-700" : "bg-white border border-gray-200"}`}
                                >
                                  <button
            ...
            {/* Pagination Controls */}
            <div
              className={`px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-3 border-t ${darkMode ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-gray-50"}`}
            >
              <div className="flex items-center gap-2">
                <span
                ...
                >
                  ...
                  {Math.min(page * limit, totalStores)} of {totalStores}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <select
                ...
                <div className="flex gap-1">
                  ...
                  <span
                    className={`px-2 text-sm font-medium flex items-center ${darkMode ? "text-gray-200" : "text-gray-700"}`}
                  >
                    {page}
                  </span>
                  <button
      ...
      >
        <div className="space-y-4">
          {uploadStats ? (
            <div className="space-y-4">
              <div
                className={`p-4 rounded-lg ${uploadStats.errorCount === 0 ? (darkMode ? "bg-green-900/20 border border-green-500/30" : "bg-green-50 border border-green-200") : darkMode ? "bg-red-900/20 border border-red-500/30" : "bg-red-50 border border-red-200"}`}
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <p
                      className={`font-bold text-lg ${uploadStats.errorCount === 0 ? "text-green-600" : "text-red-600"}`}
                    >
                      {uploadStats.errorCount === 0
                        ? "Upload Successful!"
                        : "Upload Rejected"}
                    ...
                    <p
                      className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}
                    >
                      Processed: {uploadStats.totalProcessed} | Valid:{" "}
                      {uploadStats.successCount} | Errors:{" "}
                ...
                {uploadStats.errorCount > 0 && (
                  ...
                  >
                    Fix all errors and re-upload the file. Use export buttons
                    below to download corrected data.
                  </p>
                )}
              </div>
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => handleExportUploadResults("valid")}
                  disabled={uploadStats.successCount === 0}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg font-medium text-sm"
                >
                  <Download className="w-4 h-4" /> Export Valid (
                  {uploadStats.successCount})
                </button>
                <button
                  onClick={() => handleExportUploadResults("invalid")}
                  disabled={uploadStats.errorCount === 0}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-red-600 hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg font-medium text-sm"
                >
                  <Download className="w-4 h-4" /> Export Invalid (
                  {uploadStats.errorCount})
                </button>
                <button
                  onClick={() => handleExportUploadResults("all")}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium text-sm"
                >
              ...
              >
                <div className="max-h-[400px] overflow-auto scrollbar-thin scrollbar-thumb-yellow-500 scrollbar-track-gray-200">
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead
                      className={`sticky top-0 ${darkMode ? "bg-gray-800" : "bg-gray-50"}`}
                    >
                      <tr>
                        <th
                          className={`px-3 py-2 text-left text-xs font-medium ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                        >
                          Row
                        </th>
                        <th
                    ...
                    >
                      {uploadStats.rows?.map((row: any, idx: number) => (
                        ...
                        >
                          <td
                            className={`px-3 py-2 text-xs ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                          >
                            {row.rowNumber}
                          </td>
                          <td
                          ...
                          <td
                            className={`px-3 py-2 text-xs font-mono ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                          >
                            {row.data.dealerCode || "-"}
                          </td>
                          <td
                          ...
                          <td
                            className={`px-3 py-2 text-xs ${row.status === "success" ? "text-green-600 font-semibold" : "text-red-600"}`}
                          >
              ...
              <button
                ...
                className={`w-full py-2 rounded-lg font-medium ${darkMode ? "bg-gray-700 hover:bg-gray-600 text-white" : "bg-gray-200 hover:bg-gray-300 text-gray-900"}`}
              >
                Close
              </button>
            </div>
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              {selectedFiles.length > 0 && (
                <div className="space-y-2">
                  {selectedFiles.map((file, i) => (
                    <div
                      key={i}
                      className={`flex items-center justify-between gap-3 p-3 rounded-lg border ${darkMode ? "bg-gray-800 border-gray-700" : "bg-gray-100 border-gray-200"}`}
                    >
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <FileSpreadsheet
                          className={`w-4 h-4 flex-shrink-0 ${darkMode ? "text-green-400" : "text-green-600"}`}
                        />
                        <span
                          className={`text-sm font-medium break-all ${darkMode ? "text-gray-200" : "text-gray-700"}`}
                          title={file.name}
                        >
                          {file.name}
                        </span>
                      ...
                      <button
                        ...
                        className="flex-shrink-0 p-1 rounded hover:bg-red-50 text-red-500 hover:text-red-700 transition-colors"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    </div>
              ...
              <button
                ...
                className="w-full bg-yellow-500 text-white font-bold py-2 rounded-lg hover:bg-yellow-600 disabled:opacity-50 flex justify-center items-center"
              >
                {isUploading ? (
        ...
        <div className="space-y-4">
          ...
          >
            ...
            >
              ...
              <strong>
                {singleAssignTarget
                  ? singleAssignTarget.storeName
                  : `${selectedStoreIds.size} stores`}
              </strong>{" "}
              to {assignStage === "RECCE" ? "Recce" : "Installation"} team
            </p>
          </div>
        ...
        <form onSubmit={handleAddStore} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <button
              ...
              className="px-6 py-2 bg-yellow-500 text-white rounded font-bold hover:bg-yellow-600 disabled:opacity-70 flex items-center"
            >
              {isSavingStore && (
